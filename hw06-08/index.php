...
//
//    //echo 'Коннект утсановлен';
//} catch (Exception $e) {
//    die('Подключение не удалось: ' . $e->getMessage());
//}
//
//if (isset($_POST['send'])) {
//    $stmt = $pdo->prepare("INSERT INTO student (name, age, university_id) VALUES (:name, :age, :university_id)");
//    $stmt->execute(array('name'=>$_POST['name'], 'age'=>$_POST['age'], 'university_id' => 1));
//    header('Location: /?success="Все хорошо"');
//}
//
